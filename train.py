...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./cfg/training/yolov7-hwj.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='./data/hwj.yaml', help='data.yaml path')
